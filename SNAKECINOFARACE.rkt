...
(define SNKCOLOUR "black")             ;; ---> SNKCOLOUR
(define FOODCLR "red")
(define TEXTCLR "black")
(define TEXTSIZE FIELDSIZE)
(define SCENE (empty-scene GAMEWIDTH GAMEHEIGHT)) ;; ---> SCENE
...
;; Field is (make-field Natural[1, COL] Natural[1, ROW])
;; interp. col is the column number of the field (square)
